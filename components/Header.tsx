                  ...
                  <div className="w-72 p-8 pr-4 flex flex-col justify-center">
                    <div className="space-y-2">
                      <Link 
                        ...
                        className="flex items-center gap-3 px-3 py-3 transition-all group/link"
                      >
                        ...
                        <div className="font-semibold text-lg text-[#000000] transition-colors inline-block relative pb-1 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[1px] after:bg-[#000000] after:transition-all after:duration-300 group-hover/link:after:w-[110%]">
                          Big Data & Analysis
                        </div>
                      </Link>
                  ...
                  <div className="w-96 p-6">
                    ...
                    <div className="relative h-full rounded-xl overflow-hidden m-4">
                      ...
                      <div 
                        ...
                        style={{
                          backgroundImage: 'url(/banner_calculator_new.avif)'
                        }}
                      />
                      ...
                      <div className="relative z-10 p-6 h-full flex flex-col justify-between">
                        ...
                        <Link 
                          href="/get-started"
                          className="flex items-center justify-center gap-2 w-full px-6 py-3 bg-white text-[#5919C1] rounded-xl font-semibold hover:bg-white/95 hover:shadow-lg transition-all group/estimate"
                        >
                          <span>Get My Estimate</span>
                          <svg className="w-5 h-5 -rotate-45 group-hover/estimate:rotate-0 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                ...
                <div className="relative rounded-2xl overflow-hidden min-h-[160px]">
                  ...
                  <div className="relative z-10 p-5 flex flex-col gap-3">
                    ...
                    <Link 
                      href="/get-started"
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="flex items-center justify-center gap-2 w-full px-5 py-3 bg-white text-[#5919C1] rounded-xl text-base font-semibold hover:bg-white/95 hover:shadow-lg transition-all group/estimate"
                    >
                      <span>Get My Estimate</span>
                      <svg className="w-5 h-5 -rotate-45 group-hover/estimate:rotate-0 transition-transform duration-300" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
